...
function drawRobot(state_robot, body, body_line, wheel, wheel_line, list_light_sensor, light_sensor_points,list_range_sensor, range_sensor_points, range_detect_points, range_sensor_line, is_light_sensor_visible)
